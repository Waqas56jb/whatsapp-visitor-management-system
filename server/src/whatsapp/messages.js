...
const CATALOG = {
  en: {
    ...
    submitted:
      'Your visit request has been submitted.\nReference: {ref}\nHost: {host}\nDate: {date} at {time}\n\n{host} will review it in the Client Portal. You will be notified here as soon as they respond.',
    ...
    approveDenied:
      "Visits can't be approved or rejected from this chat. Your host reviews requests in the Client Portal, and you will be notified here.",
  ...
  tn: {
    ...
    submitted:
      'Kopo ya gago ya ketelo e rometswe.\nNomoro ya tshupo: {ref}\nO etela: {host}\nLetlha: {date} ka {time}\n\n{host} o tla sekaseka kopo e mo Client Portal. O tla itsisiwe fano fa ba sena go araba.',
    ...
    approveDenied:
      'Diketelo ga di amogelwe kgotsa go ganwa mo puisanong e. Yo o mo etelang o sekaseka dikopo mo Client Portal, mme o tla itsisiwe fano.',
